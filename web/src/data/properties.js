...
export const properties = [
  {
    ...
    image: '/casas/bungalow-hero.webp',
    heroImage: '/casas/bungalow-hero.webp',
    ...
    gallery: [
      { src: '/casas/bungalow-hero.webp', caption: 'Bungalow — Vista principal' },
      { src: '/casas/bungalow-render.webp', caption: 'Bungalow — Render exterior' },
      { src: '/casas/bungalow-floorplan.webp', caption: 'Bungalow — Plano con piscina' },
    ],
    floorPlans: [
      { label: 'Planta principal', image: '/casas/bungalow-floorplan.webp' },
    ],
    floors: [
      {
  ...
  },
  {
    ...
    image: '/casas/casitas-hero.webp',
    heroImage: '/casas/casitas-hero.webp',
    ...
    gallery: [
      { src: '/casas/casitas-hero.webp', caption: 'Casita — Render ortogonal' },
      { src: '/casas/casitas-masterplan.webp', caption: 'Casita — Masterplan' },
      { src: '/casas/casitas-floorplan.webp', caption: 'Casita — Planta baja' },
    ],
    floorPlans: [
      { label: 'Planta baja', image: '/casas/casitas-floorplan.webp' },
      { label: 'Masterplan', image: '/casas/casitas-masterplan.webp' },
    ],
    floors: [
      {
        name: 'Planta baja',
  ...
  },
  {
    ...
    image: '/casas/suenos-guanacaste.webp',
    heroImage: '/casas/suenos-guanacaste.webp',
    ...
    gallery: [
      { src: '/casas/suenos-guanacaste.webp', caption: 'La Guanacaste' },
      { src: '/casas/suenos-malinche.webp', caption: 'El Malinche' },
      { src: '/casas/suenos-ceiba.webp', caption: 'La Ceiba' },
      { src: '/casas/suenos-pochote.webp', caption: 'La Pochote' },
    ],
    floorPlans: [{ label: 'La Guanacaste', image: '/casas/suenos-guanacaste.webp' }],
    floors: [
      {
  ...
  },
  {
    ...
    image: '/casas/villa-hero.webp',
    heroImage: '/casas/villa-hero.webp',
    ...
    gallery: [
      { src: '/casas/villa-hero.webp', caption: 'Villa de Casbah — Courtyard' },
      { src: '/casas/villa-living.webp', caption: 'Sala de estar' },
      { src: '/casas/villa-kitchen.webp', caption: 'Cocina' },
      { src: '/casas/villa-courtyard.webp', caption: 'Patio central' },
      { src: '/casas/villa-master.webp', caption: 'Master bedroom' },
      { src: '/casas/villa-pool.webp', caption: 'Área de piscina' },
    ],
    floorPlans: [{ label: 'Planta 3–4 BR', image: '/casas/villa-floorplan.webp' }],
    floors: [
      {
        name: 'Planta principal',
        rooms: [
